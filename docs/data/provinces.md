...
Thai National IDs encode the province in digits 2-3. There are 77 provinces in Thailand.
...
## Code Ranges by Region

| Region | Code Range |
|--------|------------|
| Central | 10-27 |
| Northeastern (Isan) | 30-49 |
| Northern | 50-58 |
| Western/Central | 60-67 |
| Western | 70-77 |
| Southern | 80-96 |

!!! note
    Not all code numbers are used. For example, codes 28-29, 59, 68-69, 78-79, and 87-89 are not assigned to any province.
